...
void createStudents ()
{
    ...
    fstream StudBin ("studentsOut.bin",ios::binary);
    if(!StudBin){cout<<"ERROR!"<<endl;}
    ...
    while (inpStud >> student.fn)
    {
        ...
        StudBin.write ((char*)&student,sizeof(StudentData));
        StudBin.seekp (sizeof(StudentData),ios::cur);
        cout<<StudBin.tellp()<<endl;

        StudBin.read((char*)&student2,sizeof(StudentData));
        StudBin.seekg(sizeof(StudentData),ios::cur);
        cout<<StudBin.tellg()<<endl;
